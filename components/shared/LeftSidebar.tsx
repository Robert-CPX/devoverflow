...
const LeftSidebar = () => {
  ...
  return (
    <section className='background-light900_dark200 light-border absolute flex h-screen flex-col items-start justify-between border-r px-6 pb-8 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]'>
